...
public class DBService {
	...
	public void instanciateTestDataBase() {
		...
		Animal animal1 = new Animal(null, 5,"Belinha", AnimalGenero.FEMEA, 'P', 'S', 'N', 'S', ong10, AnimalStatus.DISPONIVEL, raca1);
		animal1.getDoencas().addAll(Arrays.asList(doenca1,doenca4));
		Animal animal2 = new Animal(null, 8,"Charopinho", AnimalGenero.MACHO, 'P', 'S', 'S', 'N', ong10, AnimalStatus.PROCESSAMENTO, raca1);
		Animal animal3 = new Animal(null, 9,"Chulinho", AnimalGenero.MACHO, 'P', 'N', 'N', 'S', ong11, AnimalStatus.ADOTADO, raca2);
		animal3.getDoencas().addAll(Arrays.asList(doenca2,doenca3,doenca5,doenca6));
		Animal animal4 = new Animal(null, 10,"Lindinha", AnimalGenero.FEMEA, 'G', 'N', 'S', 'N', ong11, AnimalStatus.ADOTADO, raca4);
		animal4.getDoencas().addAll(Arrays.asList(doenca1,doenca2,doenca3,doenca4,doenca5));
		Animal animal5 = new Animal(null, 15,"Chulinho", AnimalGenero.FEMEA, 'G', 'N', 'N', 'S', ong11, AnimalStatus.DISPONIVEL, raca5);
